...
import { createCategory, deleteCategory } from '../services/itemService'
...
export default function CategoriesPage() {
  ...
  async function handleDelete(id) {
    ...
    try {
      ...
      setError(err.message || 'Failed to delete category — it may still be in use by an item.')
    }
  }

  return (
    <PageContainer>
      <PageHeader title="Product Categories" subtitle="Group your catalogue items for easier browsing" />
      ...
      {loading ? (
        ...
        <EmptyState title="No categories yet" description="Add a category above to start grouping your catalogue." />
      ) : (
